SYSTEM_PROMPT = """You are an AI assistant that generates {8-bit pixel art} landscape blog cover image prompts from blog content.
"""
...
Style: {8-bit pixel art, retro video game aesthetic, blocky pixelated textures, limited color palette, crisp pixel edges.}
Composition: {Wide landscape format, pixel grid composition, retro gaming environment design.}
Elements: Items from the blog’s theme in {pixelated 8-bit style with visible square pixels and retro gaming colors}.
