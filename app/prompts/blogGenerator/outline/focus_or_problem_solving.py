...
def focus_or_problem_solving_prompt(
        blog_title: str,
        primary_keyword: str, 
...
Step 2, Create an Outline for Focused or Problem Solving Category Blog: To do this, you must understand the purpose of the category. The focused or problem-solving category caters to common problems or challenges faced by the readers. These blogs directly address user concerns or challenges. This is an action-oriented blog category and your role is to help the reader solve the problem. These blogs focus on handling one major problem in one blog. The readers of the blog already have a basic understanding of the concept addressed in the blog title. With this blog they solve either of two cases, either rectify a problem which has already occurred, or avoid a problem from occuring. These problems are very industry and problem specific. The headings and sub-headings in this blog category maintain a direct tone and address the problem directly. For example, a blog talking about ‘mistakes to avoid in digital marketing’, one of the heading would be ‘neglecting to remarket’, instead of ‘build remarketing strategies’. One heading should focus on only one problem at a time. If there are multiple problems which have to be addressed, do so in different H2.


Dos for writing the headings and sub-headings of focused or problem solving category blog:


Factual and accurate information: Maintain factual accuracy in addressing the challenge of the reader. All the heading and sub-headings must be based on the facts, statistics and research. 

Numbered Lists: Break down the headings and sub-headings into simpler levels of explanation. Make the use of the numbered lists in the headings and sub-headings to ensure organization of key points, methods, steps, process, etc especially when they are mentioned in the title.

Actionable headings and sub-headings: Give clear and actionable headings with a direct tone that tell the reader about the process/need of executing any task. Maintain a conversational tone in the headings and sub-headings. 

Talk about/solve one problem in one heading: Break down the problem or its solution in the smaller chunks of headings and sub-headings. The idea behind this is to keep the users focused and understand the explanation easily. For this, maintain the framework of catering one problem in one heading. 

Maintain a logical structure: Maintain a logical structure with the headings and sub-headings broken down into simple steps and the most important aspects relating to the problem catered first. For example, for a blog talking about the problem of ‘finding the right digital marketing agency’, ‘identify the problem’ first, then understand its ‘reasons’, and then give the solutions to the problem.  

Be clear and specific: The readers of this blog want clear and specific answers/solutions for their problem. The information mentioned in the headings and sub-headings must clearly address readers and include no vagaries. For example, for a blog talking about the problem of ‘customer retention’, include the heading “Send Follow up Emails as a Part of Email Marketing Strategy”, than “Optimise Your Email Marketing Strategy for Customer Retention”. 
...
Maintain an actionable tone: The tone of the headings and sub-headings should be clear and actionable as they are focused on solving the reader’s problem. For example, for the blog titled "Effective Time Management Strategies for Remote Workers", include the heading “Set Clear Work Hours to Maintain Work-Life Balance” instead of “The Challenges of Time Management in Remote Work”.


Don’ts for writing the headings and sub-headings of focused or problem solving category blog:

Don’t be promotional: The headings and sub-headings of the blog must not promote any product, service or brand. The intent of the reader is to find the answer to their problem. However ignore this, if the answer to the user problem is directly the solution of any brand/product/service. 

Don’t overload theoretical information: The USP of a Problem Focused blog is that it directly targets the reader’s challenge and gives them answers to their questions. Don’t give headings and sub-headings which do not have an actionable value and only theoretical understanding. For example, “Use A/B Testing to Improve Conversion Rates”, this heading must be used instead of “The Psychological Principles Behind Consumer Decision-Making”. 
...
For the output involving the sub-headings of Challenges, Common Pitfalls, Mistakes to Avoid and Step-by-Step Resolutions do not give top-of-the-funnel heading or sub-heading suggestions and straightaway address the Title. Follow this instruction strictly as it is critical for the success of the task.
