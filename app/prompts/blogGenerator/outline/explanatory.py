...
Step 2, Create an Outline for an Explanatory Category Blog: To do this, you must understand the purpose of the category, the explanatory category deals with providing in-depth explanations of the concept. They are read with informational intent, with the reader interested in finding education about the concept. These blogs are very comprehensive and cover exhaustive details of concepts. These are hence written mainly from an academic point of view. However, the readers expect these explanations to be broken down into smaller chunks so that they are easier to consume. These smaller chunks must be individual concepts which come together to build the larger concept. 
 
The objective of the readers of the explanatory category is to not find a quick answer to their questions. Title, heading, and sub-headings are vital for the blogs in this category as they form the basic building blocks of knowledge for the overall topic.

Dos for giving the blog outline in the explanatory category:

Alignment with Title and Intent: Keep the headings aligned with the title and the informational intent of the readers.  
Factual Accuracy of Information: Include only the factually accurate information that is useful, relevant, and credible to the readers. 
Establish Thought Leadership: Establish thought and subject matter expertise in the concept as such it was written by a highly acclaimed professor or researcher on the concept. Give the headings to support the in-depth explanation of the concept. 
Ensure Clarity in Headings: Communicate the information in the heading and sub-headings clearly leaving no scope of ambiguity. Ensure that the readers are able to fully understand any concept within the word count constraints. Keep the headings and sub-headings well-informed yet engaging. Maintain the focus on the explanation of the single concept in a single blog heading. 
Logically Structured Headings and Sub-headings: Maintain the logical structure of the headings and sub-headings to help the readers engage in organized reading. Focus on narrowing down the levels of details with each subsequent headings and sub-headings. Place the most important detail early on in the headings. Maintain the natural progression of the flow of information such that the headings and sub-headings complement each other, building on the previous heading and sub-heading. Keep the sub-headings within the headings only as their follow-up. 


Don’ts for giving the blog outline in the explanatory category:

Don’t deviate from the subject and don’t give generic headings and sub-headings which do not add much value to the lives of the readers and which they can find anywhere else. 
Don’t include repetitive information in the headings and sub-headings and keep all of them unique and distinctive. 
Don’t include redundant, vague, and ambiguous information which leads the reader to doubt the capability of the writer.  
Don’t overwhelm the users with the details. Keep the complex explanations and concepts broken down of the headings into sub-headings.
Don’t express your personal bias and opinions and leave no scope for subjectivity as the readers for this category prefer neutral reading. 
Don’t deviate from the context of the heading in the sub-headings level and from the title in the heading level. 
Don’t include any promotional piece of information. 
