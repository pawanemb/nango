...
def creative_and_unique_prompt(
        blog_title: str,
        primary_keyword: str, 
...
Step 2, Create an Outline for Creative and Unique Category Blog: To do this, you must understand the purpose of the category. Creative and unique blog refers to the blog category with a unique angle of a concept in the blog title. These are not generic blogs that simply offer explanations of the concepts. The readers are already familiar with the concepts of the blog title. By reading a blog in this category they want surprising information about the concept. This blog category requires a high level of creative brainstorming to meet the reader’s expectations. Hence, exploration of the surface level and very complex concepts is not done in this blog category. They are highly engaging and memorable to the readers. The readers want to read a fresh perspective on the concept. You have to give the readers their aha moment! They are more of a social media post, than an educational or analytical blog. 


Dos for writing the headings and sub-headings of creative and unique category blog:

Spark thinking: The blog in this category must have headings and sub-headings which make the readers pause, think and reflect. Instead of taking a straightforward approach of plainly describing the concepts within the blog title, challenge the conventional thinking of the reader. For example, for a blog talking about ‘improving memory’, you can include the heading “Training Your Brain is Like Training Your Muscles”. This will not plainly tell that the readers need to do some mental exercises to improve their memory, but give a valid and surprising reason to practice mental exercises daily for improving their memory.
 
Take an angle: Offer distinct perspectives in the blog headings and sub-headings. This will give the readers a distinct reason to read the blog and share it with their friends. For example, for a blog talking about the ‘impact of social media in society’, you can include the heading talking about ‘how social media impacts our real life conversations’.  

Unique and fresh perspectives: Include the fresh perspective or angle to cater the concept mentioned in the blog title. The readers of this blog category are looking for something new than what they had already known and have read about the concept. For example, for a blog discussing ‘pushup exercise’, rather than telling them about ‘the benefits of pushups’, tell them about the ‘funny reasons to pushup daily’.

Maintain factual accuracy: You should maintain the factual accuracy of the suggestions in the headings and sub-headings. Be objective even if talking to the readers personally. This will improve the conversation with the readers and make the blog more credible. 

Talk to the reader directly : Write in the tone that directly talks to the readers. This will engage the readers and resonate with them personally. 

Logical structure: In being creative to deal with the blog title concept, you must ensure that your blog is logically structured with the most important headings placed first. This will bring structure to your creative discussion and keep the readers engaged till the end. For example, for a blog talking about the ‘unique ways to write Instagram captions’, talk first about the ‘creative ways to ideate’, and then talk about ‘creative ways to write’. Logically thinking happens before writing and doing otherwise will leave the readers confused. Furthermore, ensure that the blog sub-headings within a heading aligns directly with it and does not talk about an entirely different concept which can be discussed separately. 
...
Don’ts for writing the headings and sub-headings of creative and unique category blog:
...
Don’t focus on headings and sub-headings which only provide strategies and analysis but not an actionable value: Your blog headings and sub-headings must evoke thought and ideas. Catering merely to the awareness needed will not do justice to this blog type and the expectation of readers. 
