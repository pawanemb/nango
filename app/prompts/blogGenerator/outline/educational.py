...
Step 2, Create an Outline for Educational Category Blog: To do this, you must understand the purpose of the category. Educational blogs refer to the types of blogs which are created with the purpose of educating the readers on any concept or subject. They majorly have a global audience. The audience for these blogs are beginners. Their style is academic, and hence are written such that if a teacher was explaining a concept to his/her students. These can be targeted to various age groups. You should focus on having a dialogue with the readers while explaining the concept and the headings and sub-headings. Plainly educating the readers will lose their interest. Such blogs are thus required to be very engaging. Sparking the reader’s curiosity is very important for the success of a blog in this category. It is very very important for these blogs to maintain factual accuracy. The readers of the blog might not necessarily be from the same industry. For example, an educational blog about AI can be read by readers across industries, age groups and geographies. It is hence very important for these blogs to cater only to the foundational aspects of the subject and don’t overwhelm the readers with the complex and in-depth explanation of the concepts. However, while doing this, you must ensure that the reader gets to know about the concept comprehensively. 

Dos for writing the headings and sub-headings of an educational category blog


Maintain a clearly structured breakup of headings and sub-headings broken logically: Cover the basic concepts first in the headings (H2). Ensure that all the sub-headings include information specific to their heading and do not cover an unrelated topic. 

Use clear and descriptive headings: Make sure each heading gives a clear idea of what the section is about. Avoid vague or overly complex headings that confuse the reader. For example, for a blog titled “The Basics of SEO: A Beginner’s Guide”, a heading like ‘How Search Engines Rank Websites’ makes more sense than writing ‘About Website Rankings on SERP’.  

Maintain factual accuracy of information: Ensure that all the information in the blog of this category is factually correct as it will educate the reader.

Maintain the foundational understandings of the concept: Only give the foundational learnings of the concept. For example, for an educational blog discussing ‘what is digital marketing’, don’t include a heading like ‘optimizing your ad campaigns with AI’. The audience for this blog will be beginners and including such a heading will not resonate with them. 

Spark curiosity by asking questions wherever possible: Ask questions wherever possible in the headings and sub-headings to ensure participation from the readers. To ensure that the blogs in this category are a success, you must ensure that the readers are engaged. For example, for a blog talking about ‘what is email marketing’, you can include a heading like ‘is email marketing still effective?’. 

Cater to what, why and how of the topic: The headings of a blog in this category must answer the basic what, why and how questions associated with the topic. This will ensure that the readers get to learn the maximum within the constraints of the limited words. Make sure to include ‘what’ first, ‘why’ next, and then ‘how’. Please make a note that it is not necessary to have these questions as the heading to cater their answers. You can include any heading that deals in answering these questions directly. 
...
Don’ts for writing the headings and sub-headings of an educational category blog

Don’t go off-topic: Ensure that you do not include any heading or sub-heading which is redundant and is not related to the core concept covered in the blog title. For example, for a blog talking about ‘what is email marketing’, do not include the heading of ‘best email marketing tools’ as this is a separate subject. This discussion can be covered in a different blog as ‘what is email marketing’ talks about the foundational concepts of email marketing. 

Don’t give complex suggestions: Don’t give complex headings which are not suited for beginners for the subject covered in the blog title. For example, for a blog talking about ‘what is artificial intelligence’, do not include the heading or sub-heading of ‘advanced machine learning algorithms and their computational complexity’.

Don’t include your personal opinions:  A good educator does not express his/her personal beliefs unless asked in the explanation of the concept. Having any bias, giving promotional advice, or including subjective statements is not a sign of a good educator. For example, for a blog giving basic learnings about ‘climate change’, you cannot include a heading or sub-heading stating ‘climate change is overrated’.  

Don’t make assumptions: Do not assume that your readers know anything about the subject. Consider that everyone will be reading about this concept for the first time.

Don’t give false case studies and examples: Do not include case studies or examples that are not original and whose source cannot be tracked. 

Don’t give sub-heading level information that is not aligned with its heading: Ensure that all the sub-headings include information specific to their heading and do not cover an unrelated topic. For example, under the heading “The Basics of Digital Marketing”, a sub-heading “How to Code a Website” is irrelevant.

Don’t write in a dry and monotonous style: Don’t dull the reader with a dry and monotonous style of writing headings and sub-headings. For example, use the heading “Different Types of Rocks” instead of “Exploring the Three Major Rock Types and How They’re Formed”. 

Don’t overload the reader: Don’t overwhelm the readers with advanced topics relating to the concept. Keep the headings and sub-headings only to provide foundational or basic understanding of the concept. 

Don’t Include repetitive information: Don’t repeat the concepts in the headings or the sub-headings unless very necessary with the same or different wordings. 

Don’t give audience and industry specific references and information: Blogs in this category should be accessed from readers across the industry. Don’t include references which are specific to the readers of a particular industry only. For example, for the blog talking about ‘sales techniques’, don’t include the concept of ‘CRM’ without first defining it. 
