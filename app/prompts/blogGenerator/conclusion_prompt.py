...
def get_conclusion_prompt(
    ...
    """
    Generate the conclusion prompt for blog content generation.
    
    Args:
        title: Blog title
        primary_keyword: Main keyword to focus on
        secondary_keywords: List of secondary keywords
        category: Dictionary containing blog category information
        outline: Dictionary containing sections
        conclusion_results: Optional list of conclusion-specific research results
    ...
    system_prompt = """You are a highly experienced SEO content writer who is well-versed in writing engaging SEO-friendly blogs. You need to produce high-quality content for the conclusion of this blog by understanding the goals and process mentioned below. 
    """
...
Use the Primary Keyword Naturally: Position the primary keyword in the concluding section without forcing it in unnecessarily. Ideally, include it in the first 20 words of the conclusion if contextually relevant. 

Strong Conclusion: Give a Conclusion with a strong question loosely related to the overall idea. The conclusion should finish the blog by suggesting alternate ways to the user, leaving the user thinking. Do not include any further sub-headings in the conclusion. Do not write anything that has already been written in the blog. Introduce something fresh. This is very important to have job success. Make the final sentence memorable but concise so that the reader leaves with a clear takeaway relevant to their search intent. 
...
Build natural connection: You should be able to build a natural connection with the reader with content that looks human-written. The trait of human written content is that it is very less predictable. This gives the confidence to readers that the blog writer actually cares about them and has given a confident perspective rather than simply pasting the information from a different source. For example, the sentence “One must take into consideration the fact that consuming an adequate quantity of hydration on a daily basis is of utmost importance for the maintenance of optimal bodily functions.”, will be less appealing than a natural idea - "Drinking enough water every day is essential for staying healthy."
 
Use research data: Make use of the research data provided to you to include them in the content with the citation rules mentioned in the output level instructions. Doing this will ensure that it reflects authority and expertise in the domain of the blog title. 
...
Clear and simple explanations: Don’t find fancy and long-worded things to convey an idea. You must write to inform and not impress readers. Your each sentence must link with the other sentences and should be naturally placed. All the sentences of your section content must be clear and simple to understand. 

Reference to the other headings to build the context: While writing the content of the conclusion, take the reference of all the other headings in the blog also. This will help you guide the conclusion accordingly and write the content that finishes strong.

Avoiding redundancy and repetition: Avoid writing redundant ideas that are not directly related to the outline headings or the blog title. Keep the writing crisp and focused on solving users' problems. Furthermore, don’t repeat an idea once written in the content of the section. In cases, where you want to reiterate any special idea, support it with a follow-up idea, example or analogies rather than simply repeating it. 
...
Understand the outline of the blog: Understand the outline of the blog to know about the section for which you have to write. Based on this, know about the context of writing the section content and include information and ideas based on this. By understanding the outline of the blog you will come to know about the other headings and sub-headings which are to be covered in a final blog output. Write the section content based on this only to ensure that the section content reflects coherence in the final blog output. Hence, do not write the section content in vanity and ensure the natural flow of the overall blog content, by not writing section content with a standalone approach. 

Alignment with the word count: Include a maximum of 250 words in the conclusion.

Do not include subjective ideas: Do not include any subjective ideas from your end. All the sentences for writing the section content must be logical and factually accurate. Don’t express your personal beliefs and take the support of facts and research only to establish a point. For example, you can not include sentence like,  “People not using AI in future will be replaced”, for a section talking about the ‘importance of AI’. This idea is subjective and cannot be supported through research. 
