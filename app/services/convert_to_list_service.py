...
from app.services.convert_to_list_prompts import ConvertToListPrompts


class ConvertToListService:
    """
    ...
    def __init__(self, 
        ...
        """
        Initialize ConvertToListService.
    ...
    def generate_convert_to_list_workflow(
        self,
        text_to_edit: str,
        preceding_words: str = "",
        ...
        try:
            ...
            prompt = ConvertToListPrompts.get_convert_to_list_prompt(
    ...
    async def stream_convert_to_list_workflow(
        self,
        text_to_edit: str,
        ...
        Args:
            ...
            language: Target language for output
            reduction_percentage: Target reduction percentage
            before_context: Context from before the text
            after_context: Context from after the text
        ...
        try:
            ...
            for chunk_num, chunk_text in enumerate(text_chunks, 1):
                try:
                    ...
                    chunk_prompt = ConvertToListPrompts.get_streaming_convert_to_list_prompt(
